...
const Footer = () => {
  return (
    <div className="mt-12 bg-red-300 text">
      <footer className="footer p-10 -base-content">
        <div>
          <img src={logo} alt="" />
          <p className="text-xl">
            Kid's Toy House
            <br />
            All types of action available here
          </p>
        </div>
        <div>
        ...
        <div>
          <span className="footer-title">Sub Category</span>
      ...
      <div className="">
        <p className="text-center text-xl py-8">
          Copyright © 2023 - All right reserved by Kids Toy House
        </p>
      </div>
    </div>
  );
